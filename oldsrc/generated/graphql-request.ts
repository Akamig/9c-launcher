import { Address } from "../mappers";
import { ByteStringHex } from "../mappers";
import { BigInt } from "../mappers";
import {
  GraphQLResolveInfo,
  GraphQLScalarType,
...
const NodeStatusDocumentString = print(NodeStatusDocument);
const TopmostBlocksDocumentString = print(TopmostBlocksDocument);
const PreloadProgressSubscriptionDocumentString = print(
  PreloadProgressSubscriptionDocument,
);
const NodeStatusSubscriptionDocumentString = print(
  NodeStatusSubscriptionDocument,
);
const NodeExceptionDocumentString = print(NodeExceptionDocument);
const GetNcgBalanceDocumentString = print(GetNcgBalanceDocument);
const TransactionResultDocumentString = print(TransactionResultDocument);
const NodeAppProtocolVersionDocumentString = print(
  NodeAppProtocolVersionDocument,
);
const DifferentAppProtocolVersionEncounterDocumentString = print(
  DifferentAppProtocolVersionEncounterDocument,
);
const NotificationDocumentString = print(NotificationDocument);
const ValidateSnapshotDocumentString = print(ValidateSnapshotDocument);
const CollectionSheetDocumentString = print(CollectionSheetDocument);
const GetAvatarAddressDocumentString = print(GetAvatarAddressDocument);
const CollectionSheetWithStateDocumentString = print(
  CollectionSheetWithStateDocument,
);
const MinerAddressDocumentString = print(MinerAddressDocument);
const GetTipDocumentString = print(GetTipDocument);
const GetNextTxNonceDocumentString = print(GetNextTxNonceDocument);
const StateQueryMonsterCollectionDocumentString = print(
  StateQueryMonsterCollectionDocument,
);
const CollectDocumentString = print(CollectDocument);
const ClaimCollectionRewardDocumentString = print(
  ClaimCollectionRewardDocument,
);
const TransferDocumentString = print(TransferDocument);
const StagedTxDocumentString = print(StagedTxDocument);
const StageTxDocumentString = print(StageTxDocument);
const StageTxV2DocumentString = print(StageTxV2Document);
const PreloadEndedDocumentString = print(PreloadEndedDocument);
const BalanceByAgentDocumentString = print(BalanceByAgentDocument);
const TipDocumentString = print(TipDocument);
const UserStakingDocumentString = print(UserStakingDocument);
const LatestStakingSheetDocumentString = print(LatestStakingSheetDocument);
const StakingSheetDocumentString = print(StakingSheetDocument);
const V1CollectionStateDocumentString = print(V1CollectionStateDocument);
const GenesisHashDocumentString = print(GenesisHashDocument);
const StageTransactionDocumentString = print(StageTransactionDocument);
const TransferAssetDocumentString = print(TransferAssetDocument);
const StakeDocumentString = print(StakeDocument);
const ClaimStakeRewardDocumentString = print(ClaimStakeRewardDocument);
const MigrateMonsterCollectionDocumentString = print(
  MigrateMonsterCollectionDocument,
);
const CheckContractedDocumentString = print(CheckContractedDocument);
const ApprovePledgeDocumentString = print(ApprovePledgeDocument);
const CheckPatchTableDocumentString = print(CheckPatchTableDocument);
export function getSdk(
  ...
  return {
    NodeStatus(
      variables?: NodeStatusQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: NodeStatusQuery;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<NodeStatusQuery>(
            NodeStatusDocumentString,
            variables,
    ...
    TopmostBlocks(
      variables?: TopmostBlocksQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: TopmostBlocksQuery;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<TopmostBlocksQuery>(
            TopmostBlocksDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "TopmostBlocks",
    ...
    PreloadProgressSubscription(
      variables?: PreloadProgressSubscriptionSubscriptionVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<PreloadProgressSubscriptionSubscription>(
            PreloadProgressSubscriptionDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "PreloadProgressSubscription",
    ...
    NodeStatusSubscription(
      variables?: NodeStatusSubscriptionSubscriptionVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: NodeStatusSubscriptionSubscription;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<NodeStatusSubscriptionSubscription>(
            NodeStatusSubscriptionDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "NodeStatusSubscription",
    ...
    NodeException(
      variables?: NodeExceptionSubscriptionVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: NodeExceptionSubscription;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<NodeExceptionSubscription>(
            NodeExceptionDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "NodeException",
    ...
    GetNCGBalance(
      variables: GetNcgBalanceQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: GetNcgBalanceQuery;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<GetNcgBalanceQuery>(
            GetNcgBalanceDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "GetNCGBalance",
    ...
    TransactionResult(
      variables: TransactionResultQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: TransactionResultQuery;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<TransactionResultQuery>(
            TransactionResultDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "TransactionResult",
    ...
    NodeAppProtocolVersion(
      variables?: NodeAppProtocolVersionQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: NodeAppProtocolVersionQuery;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<NodeAppProtocolVersionQuery>(
            NodeAppProtocolVersionDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "NodeAppProtocolVersion",
    ...
    DifferentAppProtocolVersionEncounter(
      variables?: DifferentAppProtocolVersionEncounterSubscriptionVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: DifferentAppProtocolVersionEncounterSubscription;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<DifferentAppProtocolVersionEncounterSubscription>(
            DifferentAppProtocolVersionEncounterDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "DifferentAppProtocolVersionEncounter",
    ...
    Notification(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<NotificationSubscription>(
            NotificationDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "Notification",
    ...
    ValidateSnapshot(
      variables: ValidateSnapshotQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: ValidateSnapshotQuery;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<ValidateSnapshotQuery>(
            ValidateSnapshotDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "ValidateSnapshot",
    ...
    CollectionSheet(
      variables?: CollectionSheetQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: CollectionSheetQuery;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<CollectionSheetQuery>(
            CollectionSheetDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "CollectionSheet",
    ...
    GetAvatarAddress(
      variables: GetAvatarAddressQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<GetAvatarAddressQuery>(
            GetAvatarAddressDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "GetAvatarAddress",
    ...
    CollectionSheetWithState(
      variables: CollectionSheetWithStateQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: CollectionSheetWithStateQuery;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<CollectionSheetWithStateQuery>(
            CollectionSheetWithStateDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "CollectionSheetWithState",
    ...
    MinerAddress(
      variables?: MinerAddressQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: MinerAddressQuery;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<MinerAddressQuery>(
            MinerAddressDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "MinerAddress",
    ...
    GetTip(
      variables?: GetTipQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: GetTipQuery;
      extensions?: any;
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<GetTipQuery>(GetTipDocumentString, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "GetTip",
    ...
    GetNextTxNonce(
      variables: GetNextTxNonceQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: GetNextTxNonceQuery;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<GetNextTxNonceQuery>(
            GetNextTxNonceDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "GetNextTxNonce",
    ...
    StateQueryMonsterCollection(
      variables: StateQueryMonsterCollectionQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: StateQueryMonsterCollectionQuery;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<StateQueryMonsterCollectionQuery>(
            StateQueryMonsterCollectionDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "StateQueryMonsterCollection",
    ...
    Collect(
      variables: CollectMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: CollectMutation;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<CollectMutation>(CollectDocumentString, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "Collect",
    ...
    ClaimCollectionReward(
      variables: ClaimCollectionRewardMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: ClaimCollectionRewardMutation;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<ClaimCollectionRewardMutation>(
            ClaimCollectionRewardDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "ClaimCollectionReward",
    ...
    Transfer(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<TransferMutation>(
            TransferDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "Transfer",
    ...
    StagedTx(
      variables: StagedTxQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: StagedTxQuery;
      extensions?: any;
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<StagedTxQuery>(StagedTxDocumentString, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "StagedTx",
    ...
    StageTx(
      variables: StageTxMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: StageTxMutation;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<StageTxMutation>(StageTxDocumentString, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "StageTx",
    ...
    StageTxV2(
      variables: StageTxV2MutationVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: StageTxV2Mutation;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<StageTxV2Mutation>(
            StageTxV2DocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "StageTxV2",
    ...
    PreloadEnded(
      variables?: PreloadEndedQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: PreloadEndedQuery;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<PreloadEndedQuery>(
            PreloadEndedDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "PreloadEnded",
    ...
    BalanceByAgent(
      variables: BalanceByAgentSubscriptionVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: BalanceByAgentSubscription;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<BalanceByAgentSubscription>(
            BalanceByAgentDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "BalanceByAgent",
    ...
    Tip(
      variables?: TipSubscriptionVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: TipSubscription;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<TipSubscription>(TipDocumentString, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "Tip",
    ...
    UserStaking(
      variables: UserStakingQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: UserStakingQuery;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<UserStakingQuery>(
            UserStakingDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "UserStaking",
    ...
    LatestStakingSheet(
      variables?: LatestStakingSheetQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: LatestStakingSheetQuery;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<LatestStakingSheetQuery>(
            LatestStakingSheetDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "LatestStakingSheet",
    ...
    StakingSheet(
      variables?: StakingSheetQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: StakingSheetQuery;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<StakingSheetQuery>(
            StakingSheetDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "StakingSheet",
    ...
    V1CollectionState(
      variables: V1CollectionStateQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: V1CollectionStateQuery;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<V1CollectionStateQuery>(
            V1CollectionStateDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "V1CollectionState",
    ...
    GenesisHash(
      variables?: GenesisHashQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: GenesisHashQuery;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<GenesisHashQuery>(
            GenesisHashDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "GenesisHash",
    ...
    stageTransaction(
      variables: StageTransactionMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: StageTransactionMutation;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<StageTransactionMutation>(
            StageTransactionDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "stageTransaction",
    ...
    transferAsset(
      variables: TransferAssetQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: TransferAssetQuery;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<TransferAssetQuery>(
            TransferAssetDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "transferAsset",
    ...
    Stake(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<StakeQuery>(StakeDocumentString, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "Stake",
    ...
    ClaimStakeReward(
      variables: ClaimStakeRewardQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: ClaimStakeRewardQuery;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<ClaimStakeRewardQuery>(
            ClaimStakeRewardDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "ClaimStakeReward",
    ...
    MigrateMonsterCollection(
      variables: MigrateMonsterCollectionQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: MigrateMonsterCollectionQuery;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<MigrateMonsterCollectionQuery>(
            MigrateMonsterCollectionDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "MigrateMonsterCollection",
    ...
    CheckContracted(
      variables: CheckContractedQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: CheckContractedQuery;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<CheckContractedQuery>(
            CheckContractedDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "CheckContracted",
    ...
    approvePledge(
      variables: ApprovePledgeQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: ApprovePledgeQuery;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<ApprovePledgeQuery>(
            ApprovePledgeDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "approvePledge",
    ...
    CheckPatchTable(
      variables?: CheckPatchTableSubscriptionVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<{
      data: CheckPatchTableSubscription;
      extensions?: any;
      headers: Dom.Headers;
      status: number;
    }> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<CheckPatchTableSubscription>(
            CheckPatchTableDocumentString,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders },
          ),
        "CheckPatchTable",
